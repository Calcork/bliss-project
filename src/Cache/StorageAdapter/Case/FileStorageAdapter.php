...
namespace Hizech\Bliss\Cache\StorageAdapter\Case;
...
class FileStorageAdapter implements StorageAdapter
{
    ...
    public function getCache(string $item, string $instance): ?string
    {
    ...
    {
        return $this->cache_dir . DIRECTORY_SEPARATOR . $this->sanitize($item) . '.cache';
    }
